<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewAdmissionCallback.aspx.cs" Inherits="TPW_GMS.NewAdmissionCallback" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        function loadData() {
            ...
            formData["reportType"] = "NewAdmissionCallBack";
            if (table) {
            ...
            table = $('#dtTable').DataTable({
                ...
                columns: [
                    ...
                    { 'data': 'newAdmissionCallStatus' },
                    { 'data': 'newAdmissionCallRemark' },
                    {
                        'data': null,
                        'className': 'center',
                ...
                rowCallback: function (row, data) {
                    if (data["newAdmissionCallStatus"] == "Called") {
                        $(row).addClass('success')
                    }
                    else if (data["newAdmissionCallStatus"] == "Called but didn't received") {
                        $(row).addClass('info')
                    }
            ...
            $(document).on('click', '#dtTable a.editor_View', function () {
                ...
                $('#ddlCallStatus').val(data['newAdmissionCallStatus']);
                $('#txtRemark').val(data['newAdmissionCallRemark']);
        ...
        function updateData() {
            ...
            params.append('newAdmissionCallStatus', $('#ddlCallStatus').val());
            params.append('newAdmissionCallRemark', $('#txtRemark').val());
            axios({
                url: 'api/UpdateMemberInformationNewAdmissionCallBack',
                method: 'post',
                data: params,
                dataType: "JSON",
                headers: {
    ...
    <asp:HiddenField ID="hidHeader" runat="server" Value="New Admission Callback" />
